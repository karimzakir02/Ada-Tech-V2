...
export class RemoveColumns extends Component {
  ...
  createDatasetSelect() {
    var select = document.getElementById("remove_columns_dataframe_select");
    select.innerHTML = "";
  ...
  createColumnSelect(select_value){
    var select = document.getElementById("remove_columns_column_select");
    select.innerHTML = "";
  ...
  handleClick() {
    ...
    render() {
      return(
          <li class="bold">
            <a onClick={this.prepareComponent} class="collapsible-header white-text"><span style={{marginLeft: "10px"}}>Remove Columns</span></a>
            <div class="collapsible-body">
                <div class="row" style={{paddingTop: "6%", marginBottom:0}}>
                  ...
                  <div class="input-field col s12 m6">
                    <select multiple id="remove_columns_column_select" onChange={this.handleColumnSelectChange}></select>
                    <label for="remove_columns_column_select">Column(s) to Remove</label>
                  </div>
                </div>
                <div class="divider"></div>
                <div class="section" style={{paddingTop: "4%"}}>
                  <button class="btn-flat modal-trigger" href="#remove_columns_modal">Options</button>
