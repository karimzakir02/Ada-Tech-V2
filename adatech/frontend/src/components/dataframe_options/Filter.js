...
export class Filter extends Component {
  ...
  createDatasetSelect() {
    var select = document.getElementById("filter_dataframe_select");
    select.innerHTML = "";
  ...
  handleClick() {
    ...
    render() {
      return(
          <li class="bold">
            <a onClick={this.prepareComponent} class="collapsible-header white-text"><span style={{marginLeft: "10px"}}>Filter</span></a>
            <div class="collapsible-body">
                <div class="row" style={{paddingTop: "6%", marginBottom:0}}>
                  <div class="input-field col s12">
                    <select id="filter_dataframe_select" onChange={this.handleDatasetChange}></select>
                    <label>Dataframe:</label>
                  </div>
                  <div class="input-field col s12">
                    <input placeholder="(col1 == 'value') and (col2 > x)" type="text" name="value" id="filter_key_input" onChange={this.handleFilterKeyChange} />
                    <label for="filter_key_input">Value:</label>
                  </div>
                </div>
                <div class="divider"></div>
                <div class="section" style={{paddingTop: "4%"}}>
                  <button class="btn-flat modal-trigger" href="#filter_modal">Options</button>
